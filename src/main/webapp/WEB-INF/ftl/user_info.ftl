...
<head>
    ...
    <script src="/yo-party-net/js/sitelogo/jquery-2.1.4.js"></script>
    <link href="/yo-party-net/css/sitelogo/cropper/cropper.min.css" rel="stylesheet">
    <link href="/yo-party-net/css/sitelogo/sitelogo/sitelogo.css" rel="stylesheet">
    <script src="/yo-party-net/js/sitelogo/cropper/cropper.min.js"></script>
    <script src="/yo-party-net/js/sitelogo/sitelogo/sitelogo4frame.js"></script>
    <script src="/yo-party-net/js/sitelogo/bootstrap/js/bootstrap.min.js"></script>
</head>
<body>
