 ...
 */
/*******************************************************************************
 * 鎻愮ず************************ 鎵€鏈夎娉ㄩ噴鐨勯厤缃」鍧囦负UEditor榛樿鍊笺€� 淇敼榛樿閰嶇疆璇烽鍏堢‘淇濆凡缁忓畬鍏ㄦ槑纭鍙傛暟鐨勭湡瀹炵敤閫斻€�
...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        // lang鍊间篃鍙互閫氳繃鑷姩鑾峰彇 (navigator.language||navigator.browserLanguage
        ...
        // 鎻愪氦琛ㄥ崟鏃讹紝鏈嶅姟鍣ㄨ幏鍙栫紪杈戝櫒鎻愪氦鍐呭鐨勬墍鐢ㄧ殑鍙傛暟锛屽瀹炰緥鏃跺彲浠ョ粰瀹瑰櫒name灞炴€э紝浼氬皢name缁欏畾鐨勫€兼渶涓烘瘡涓疄渚嬬殑閿€硷紝涓嶇敤姣忔瀹炰緥鍖栫殑鏃跺€欓兘璁剧疆杩欎釜鍊�

        // ,initialContent:'娆㈣繋浣跨敤ueditor!'
        // //鍒濆鍖栫紪杈戝櫒鐨勫唴瀹�,涔熷彲浠ラ€氳繃textarea/script缁欏€硷紝鐪嬪畼缃戜緥瀛�

        // ,autoClearinitialContent:true
        // //鏄惁鑷姩娓呴櫎缂栬緫鍣ㄥ垵濮嬪唴瀹癸紝娉ㄦ剰锛氬鏋渇ocus灞炴€ц缃负true,杩欎釜涔熶负鐪燂紝閭ｄ箞缂栬緫鍣ㄤ竴涓婃潵灏变細瑙﹀彂瀵艰嚧鍒濆鍖栫殑鍐呭鐪嬩笉鍒颁簡
        ...
        // //getContent鏃讹紝鏄惁鍒犻櫎绌虹殑inlineElement鑺傜偣锛堝寘鎷祵濂楃殑鎯呭喌锛�
        ...
        // //鏄惁寮€鍚〃鎯呮湰鍦板寲锛岄粯璁ゅ叧闂€傝嫢瑕佸紑鍚纭繚emotion鏂囦欢澶逛笅鍖呭惈瀹樼綉鎻愪緵鐨刬mages琛ㄦ儏鏂囦欢澶�
        ...
        // style="color:red;">浣犺緭鍏ョ殑瀛楃涓暟宸茬粡瓒呭嚭鏈€澶у厑璁稿€硷紝鏈嶅姟鍣ㄥ彲鑳戒細鎷掔粷淇濆瓨锛�</span>
        ...
        // textAlign:"left", //娈佃惤鐨勬帓鐗堟柟寮忥紝鍙互鏄� left,right,center,justify
        // 鍘绘帀杩欎釜灞炴€ц〃绀轰笉鎵ц鎺掔増
        // imageBlockLine: 'center', //鍥剧墖鐨勬诞鍔ㄦ柟寮忥紝鐙崰涓€琛屽墽涓�,宸﹀彸娴姩锛岄粯璁�:
        // center,left,right,none 鍘绘帀杩欎釜灞炴€ц〃绀轰笉鎵ц鎺掔増
        ...
        // codeMirrorJsUrl js鍔犺浇鐨勮矾寰勶紝榛樿鏄� URL +
        // "third-party/codemirror/codemirror.js"
        // ,codeMirrorJsUrl:URL + "third-party/codemirror/codemirror.js"
        // codeMirrorCssUrl css鍔犺浇鐨勮矾寰勶紝榛樿鏄� URL +
        ...
        // webAppKey
        // 鐧惧害搴旂敤鐨凙PIkey锛屾瘡涓珯闀垮繀椤婚鍏堝幓鐧惧害瀹樼綉娉ㄥ唽涓€涓猭ey鍚庢柟鑳芥甯镐娇鐢╝pp鍔熻兘锛屾敞鍐屼粙缁嶏紝http://app.baidu.com/static/cms/getapikey.html
        // , webAppKey: ""
