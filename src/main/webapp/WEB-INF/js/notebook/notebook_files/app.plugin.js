!function ($) {
    ...
    $(function () {
        ...
        // fontawesome
        $(document).on('click', '.fontawesome-icon-list.ftl a', function (e) {
            e && e.preventDefault();
        });
        ...
        function addMsg($msg) {
            ...
            $($msg).hide().prependTo($el.find('.list.ftl-group')).slideDown().css('display', 'block');
        }

        var $msg = '<a href="#" class="media list.ftl-group-item">' +
